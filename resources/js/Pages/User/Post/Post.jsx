...
function PostComponent({postsData = [], hasMoreData = false,fetchUrl,filterTypeComponent=false,filterVisibilityComponent=false,displayCommunityName=true}){
    ...
    return(
        <>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline",marginBottom:"10px" }}>
                ...
                <div className="mobileFilter filter-container">
                    <Dropdown>
                            ...
                            <div className="post-header-center">
                                ...
                                >
                                    <p style={{fontWeight:"500"}}>
                                        {post.nickname ? post.nickname : auth.user.nickname} &nbsp; 
                                ...
                                <p><span>{post.is_private==="Public" ? (<i className='fa fa-globe'>&nbsp;</i>) :(<i className='bx bxs-lock-alt'>&nbsp;</i>)}</span>{new Date(post.created_at).toLocaleString()} </p>
                                {(displayCommunityName && post.community_name != null) && <Link className='post-detail-btn' href={route('user.communityProfile',post.communities_id)}><span style={{color:"black",fontWeight:"400"}}> from </span>{post.community_name}</Link>}
                                ...
                                <Dropdown.Menu>
                                    ...
                                    <Dropdown.Item 
                                        onClick={() =>
                                          ...
                                          disabled={processing}
                                    ><i className='fa fa-globe' style={{color:"#543A14"}}> Public</i>
                                    </Dropdown.Item>}
                                </Dropdown.Menu>
                            </Dropdown>}
                            </div>
