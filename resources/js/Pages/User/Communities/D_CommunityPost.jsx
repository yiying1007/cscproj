...
function CommunityPost(){
    ...
    const { community,posts: initialPosts, hasMorePosts: initialHasMore,auth,postTypes=[] } = usePage().props;
    ...
    const loadMorePosts = async () => {
        ...
        try {
            const res = await fetch(`loadCommunityPosts/${community.id}?page=${page + 1}`,{
    ...
    return(
        <>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline",marginBottom:"10px" }}>
                <h3 className="titleName">Community Posts</h3>
                ...
                return (
                    <div className="post-border" key={post.id}>
                        ...
                        <div className="post-header">
                            ...
                            >
                                <p style={{fontWeight:"500"}}>{post.nickname} {(post.member_position==="Leader" || post.member_position==="Admin") && <span className='position-tag'>{post.member_position}</span>} </p>
                            </Link>
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    ...
                                    <Dropdown.Item 
                                        onClick={() => handleDeleteShow(post)}>delete</Dropdown.Item>
