...
function CreateUserIdentityModal({users}){
    ...
    function formSubmit(e){
        ...
        post(route('admin.createUserIdentity'), {
            onSuccess: () => {
        ...
        <div>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Create User Identity</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default CreateUserIdentityModal;