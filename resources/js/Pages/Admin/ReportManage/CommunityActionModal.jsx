...
function CommunityModal({community}) {
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <div className="detailGrid">
                        <span className="detailLabel">Community Name</span> 
                        <span className="detailContent">{community.community_name}</span>

                        <span className="detailLabel">Community Type</span> 
                        <span className="detailContent">{community.community_type}</span>

                        <span className="detailLabel">Community Description</span> 
                        <span className="detailContent">{community.description || "-"}</span>

                        <span className="detailLabel">Community Avatar</span> 
                        <span className="detailContent">
                            <div className='content-media '>
                                <img src={communityAvatarUrl} style={{width:"50%"}}/>
                            </div>
                        </span>
...
function CommunityReportModal({report}){
    const [show, setShow] = useState(false);
    const handleClose = () => setShow(false);
    const handleShow = () => setShow(true);
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <div className="detailGrid">
                        ...
                        <span className="detailContent" style={{display:"flex",gap:"20px"}}><CommunityModal community={report} /><UserModal user={report} /></span>
...
function DeleteCommunityModal({report}){
...
export {CommunityReportModal,DeleteCommunityModal};