...
import { CommunityReportModal,DeleteCommunityModal } from './CommunityActionModal';
DataTable.use(DT);

function CommunityReportManagement(){

    const { auth,communityReports } = usePage().props;
    ...
    return(
        <div>
            ...
            <div className="controlbar">
                <h5>Community Report Management </h5>
                            ...
                            return (
                                ...
                                <td>
                                    <div className='actionStyle'>
                                        <CommunityReportModal report={report} />
                                        {auth.admin.position==="Super Admin" && <DeleteCommunityModal report={report} />}
                                    </div>
                                </td>
                                </tr>
                            );
...
export default CommunityReportManagement; 
