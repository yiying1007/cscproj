...
function ReportModal({report}){
    ...
    const handleClose = () => setShow(false);
    const handleShow = () => setShow(true);
    const mediaUrl = report.media_url ? report.media_url : null;
    //media component
    const getMediaComponent = (media, mediaName) => {
        ...
        if (media.match(/\.(jpeg|jpg|gif|png)$/)) {
            ...
            return (
                <div className="message-file-border">
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <div className="detailGrid">
                        ...
                        <span className="detailLabel">Message</span> 
                        <span className="detailContent">
                            {report.content || getMediaComponent(mediaUrl,report.media_name)} 
                        </span>

                        <span className="detailLabel">User Detail</span> 
                        <span className="detailContent"><UserModal user={report} /></span>
