...
function BlockCommentModal({comment}) {
    ...
    function reportSubmit(e){
        ...
        //use inertia js--useForm--post submit data
            ...
            post(route('admin.blockComment', { commentId: comment.id }), {
                onSuccess: () => {
    ...
    return (
        <>
        <button className="btn btn-success btn-sm" onClick={handleReportShow} disabled={comment.status === "Block"}>Block</button>
        
        
        <Modal show={reportshow} onHide={handleReportClose}>
            <Modal.Header closeButton>
                <Modal.Title>Block Comment</Modal.Title>
            </Modal.Header>
            <Modal.Body>
