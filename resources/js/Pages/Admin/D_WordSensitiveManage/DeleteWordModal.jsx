...
function DeleteWordModal({sensitiveWord}){
    ...
    const { delete:deleteWord,processing } = useForm();
    
    function formSubmit(e){
        //prevent auto refresh when click submit
        e.preventDefault();
        //use inertia js--useForm--post submit data
        deleteWord(route('admin.deleteWord',sensitiveWord.id), {
            onSuccess: () => {
        ...
        <div>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Delete Sensitive Word</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <form onSubmit={formSubmit}>
                        
                        <h5>Are you sure to delete this word?</h5>
                        <hr />
